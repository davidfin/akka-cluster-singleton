...
class Game(players: Set[ActorRef], moveCount: Long, moveTimeout: FiniteDuration, sparseness: Int)
  ...
  def becomeHandlingMove(moveNumber: Long): Unit = {
  ...
  def sendMakeMove(moveNumber: Long): Unit = {
